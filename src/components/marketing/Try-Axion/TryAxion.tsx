    ...
    <div className="h-screen w-full overflow-hidden bg-white">
      <div className="mx-auto mt-40 w-full max-w-2xl">
        <div className="text-center font-serif">
          ...
          <br />
          <span className="text-3xl m-12 font-light tracking-tight leading-loose ">
      ...
      <div className="relative -mt-24 h-96 w-full overflow-hidden [mask-image:radial-gradient(60%_60%,white,transparent)]">
        ...
        <div className="absolute -left-1/2 top-1/2 aspect-[1/0.6] z-10 w-[200%] rounded-[100%] border-t border-zinc-950/50 bg-white" />
        <Sparkles
          density={2000}
